...
$consulta_total_filas = "SELECT COUNT(*) AS total_filas FROM tbl_tareas";
...
$sql = "SELECT id_tarea, nombre_tarea, descripcion FROM tbl_tareas WHERE estado = 1 LIMIT $inicio, $filas_por_pagina";
                    ...
                    <tbody>
                        ...
                        if($resultado->num_rows > 0){
                            ...
                            while($row = $resultado->fetch_assoc()){
                                ...
                                echo "<td> 
                                        <a href='ingresar_notas.php?id_tarea=" . $row['id_tarea'] . "' class='btn btn-primary btn-sm'>Ingresar Nota</a>
                                    </td>";
                                echo "</tr>";
                            }
                        }else{
