...
LEFT JOIN 
    tbl_nota_total nt ON al.id_alumno = nt.codigo_alumno
LEFT JOIN 
    ...
    $tabla .= "
        <tr>
            ...
            <td>
                ...
                <button class='btn-opcion text-primary'  title='Imprimir Notas' onclick='window.location.href=\"imprimir_notas.php?id={$registro['id_alumno']}\"'><i class='fas fa-sticky-note'></i></button>
            </td>
        </tr>
    ";
}
